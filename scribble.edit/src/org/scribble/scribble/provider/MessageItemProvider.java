...
/**
 * This is the item provider adapter for a {@link org.scribble.scribble.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_sender_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_sender_feature", "_UI_Message_type"),
				 ScribblePackage.Literals.MESSAGE__SENDER,
				 true,
				 false,
				 false,
	...
	protected void addReceiverPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_receiver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_receiver_feature", "_UI_Message_type"),
				 ScribblePackage.Literals.MESSAGE__RECEIVER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScribblePackage.Literals.MESSAGE__SIGNATURE);
		}
	...
	public String getText(Object object) {
		String label = ((Message)object).getSender();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScribblePackage.Literals.MESSAGE__SIGNATURE,

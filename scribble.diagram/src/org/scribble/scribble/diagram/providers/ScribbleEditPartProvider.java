...
import org.scribble.scribble.diagram.edit.parts.ScribbleEditPartFactory;
 ...
 * @generated
 */
public class ScribbleEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public ScribbleEditPartProvider() {
		setFactory(new ScribbleEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!ScribbleProgramEditPart.MODEL_ID
					.equals(ScribbleVisualIDRegistry.getModelID(view))) {
				return false;
			}

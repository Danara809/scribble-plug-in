 ...
 * @generated
 */
public class ScribbleInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ScribbleNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ScribbleProgramEditPart.MODEL_ID));
		ScribbleDiagramEditorUtil.runWizard(getShell(), wizard,

...
import org.scribble.scribble.diagram.edit.policies.ScribbleTextSelectionEditPolicy;
 ...
 * @generated
 */
public class GlobalProtocolDeclProtocolNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public GlobalProtocolDeclProtocolNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ScribbleTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ScribbleProgramEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return ScribbleElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScribbleParserProvider
					.getParser(
							ScribbleElementTypes.GlobalProtocolDecl_2002,
							getParserElement(),
							ScribbleVisualIDRegistry
									.getType(org.scribble.scribble.diagram.edit.parts.GlobalProtocolDeclProtocolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ScribbleEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

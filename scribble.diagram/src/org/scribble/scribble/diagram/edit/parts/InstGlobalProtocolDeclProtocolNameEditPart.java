 ...
 * @generated
 */
public class InstGlobalProtocolDeclProtocolNameEditPart extends
	 ...
	 * @generated
	 */
	public InstGlobalProtocolDeclProtocolNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScribbleParserProvider
					.getParser(
							...
							ScribbleVisualIDRegistry
									.getType(org.scribble.scribble.diagram.edit.parts.InstGlobalProtocolDeclProtocolNameEditPart.VISUAL_ID));
		}
		return parser;
	}

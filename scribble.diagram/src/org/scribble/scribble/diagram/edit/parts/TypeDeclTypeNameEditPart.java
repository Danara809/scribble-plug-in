 ...
 * @generated
 */
public class TypeDeclTypeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TypeDeclTypeNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScribbleParserProvider
					.getParser(
							...
							ScribbleVisualIDRegistry
									.getType(org.scribble.scribble.diagram.edit.parts.TypeDeclTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
